...
1. **Code**
    1. Version control
        - [Git]() Pretty much the right choice.
    2. Clear branching and commit strategy
...
2. **Dependencies**
    1. Package managers
        1. whatever the standard for your language is. [yarn](https://yarnpkg.com/) or [npm](https://www.npmjs.com/) are good for js.
    2. Patching and upgrading
        1. the package manager handles the operations of downloading, caching and tracking dependency artifacts. Combined with [Semantic Versioning](https://semver.org/) you can (to some degree) specify your update policy, and then you actually do the updating as part of your development process!
    3. Isolation and separation of concerns
        1. using a package manager and approaching these dependencies in such a way that they are black boxes with known inputs and outputs you can go ahead and not give a damn about them except how you use them / how you deal with them. Separated!
